...
@Path("/GetTopUserVote")
public class GetTopUserVoteResource {
    @EJB
    VoteService voteService;

    @GET
    @Produces({MediaType.APPLICATION_JSON})
    public Response getTopUserVote(@QueryParam("idolId") String idolId, @QueryParam("index") Integer index) {
        Integer retCode = 0;
        Boolean isLastPage = false;
        String leaderboardKey = "leaderboard:userVote:" + idolId;
        ...
        //check isLastPage
        isLastPage = voteService.isLastPage(leaderboardKey, index);
